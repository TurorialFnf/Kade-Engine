...
class Minigame extends MusicBeatState
{
	...
	var obstaclefive:FlxSprite;
	var obstaclesix:FlxSprite;
	var obstacleseven:FlxSprite;
	var obstacleeight:FlxSprite;
	var obstaclenine:FlxSprite;
	var obstacleten:FlxSprite;
	var obstacleeleven:FlxSprite;
	var obstacletwelve:FlxSprite;
	var obstaclethirteen:FlxSprite;
	...
	override public function create():Void
	{
		...
		FlxG.sound.playMusic(Paths.music('minigamemusic'), 0.5);
		...
		door = new FlxSprite(-30, 200);
		door.makeGraphic(100, 200, FlxColor.BROWN);
		

		obstacle = new FlxSprite(0, 0);
		obstacle.makeGraphic(50, 200, FlxColor.ORANGE);
		obstacletwo = new FlxSprite(0, 500);
		obstacletwo.makeGraphic(50, 200, FlxColor.ORANGE);
		obstaclethree = new FlxSprite(1226, 0);
		obstaclethree.makeGraphic(50, 200, FlxColor.ORANGE);
		obstaclefour = new FlxSprite(1226, 500);
		obstaclefour.makeGraphic(50, 200, FlxColor.ORANGE);
		obstaclefive = new FlxSprite(2452, 0);
		obstaclefive.makeGraphic(50, 200, FlxColor.ORANGE);
		obstaclesix = new FlxSprite(2452, 500);
		obstaclesix.makeGraphic(50, 200, FlxColor.ORANGE);

		obstacleseven = new FlxSprite(0, obstacletwo.y + 200);
		obstacleseven.makeGraphic(1226, 50, FlxColor.ORANGE);
	...
	override function update(elapsed:Float)
	{
		...
		//if(bf.overlaps(door))
		//{
			//FlxG.switchState(new MinigameTwo());
		//}
